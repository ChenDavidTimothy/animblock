...
class Sphere(Shape):
    ...
    def preventOverlap(self, other):
        ...
        distanceNorm = (
            distanceVec[0] / distanceLen,
            distanceVec[1] / distanceLen,
            distanceVec[2] / distanceLen,
        )

        minimumTranslationVector = (
            -distanceNorm[0] * minTransLen,
            -distanceNorm[1] * minTransLen,
            -distanceNorm[2] * minTransLen,
        )
