...
from ..core import RenderTarget, Uniform
...
class DirectionalLight(Light):
    def __init__(self, position=None, color=None, strength=1, direction=None):
    ...
    def enableShadows(self, strength=0.5, bias=0.005, size=None):
